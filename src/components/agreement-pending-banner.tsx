...
export function AgreementPendingBanner() {
  ...
  return (
    <div className="tint-warning flex items-center justify-between gap-3 border-b px-4 py-2.5">
      <div className="flex min-w-0 items-center gap-2 text-[13px]">
        <FileSignature className="h-4 w-4 shrink-0 text-warning-foreground" />
        <span className="shrink-0 font-semibold text-warning-foreground">Action required</span>
        <span className="truncate text-warning-foreground/80">{message}</span>
      </div>
