 ...
 *
 * Also used (2026-08-06) for the §2.4 Task/Ticket interim fix: neither
 * table has a participant-tag table like deal_participants/
 * customer_participants, so their read scope narrows to "tasks I created or
 * am assigned to" / "tickets I raised" instead — see the tasks/
 * support_tickets branches below, mirroring authorizeTaskActor/
 * authorizeTicketActor's identical restriction on the write side. */
