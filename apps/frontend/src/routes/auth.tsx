...
import { googleSignInUrl, supabase } from "@/integrations/local/client";
...
// Full-page redirect to the backend's OAuth entry point — a plain link, not a
// client-side auth call. Works for both login and signup; which one happens is
// decided server-side once Google's identity comes back.
