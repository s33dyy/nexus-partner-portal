...
import { getCatalogKindLabel, normalizeCatalogKind, type CatalogKind } from "@/lib/catalog";
    ...
    if (resolvedSource === "catalog") {
      try {
        ...
        const nextOption: DropdownOption = {
          ...
          description: `${getCatalogKindLabel(normalizeCatalogKind(created.catalog_kind))} · ${created.sku}`,
          source: "catalog",
        };
