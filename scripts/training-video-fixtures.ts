export const TRAINING_ACCOUNTS = {
  ...
  northstarUsers: {
    ops: {
      email: "northstar.ops@livey.tech",
      password: "Northstar-Ops-2026!",
    },
    sales: {
      email: "northstar.sales@livey.tech",
      password: "Northstar-Sales-2026!",
    },
  },
  harborAdmin: {
  ...
  harborUsers: {
    user: {
      ...
      password: "Harbor-User-2026!",
    },
    ops: {
      email: "harbor.ops@livey.tech",
      password: "Harbor-Ops-2026!",
    },
    support: {
      email: "harbor.support@livey.tech",
      password: "Harbor-Support-2026!",
    },
  },
} as const;
...
export const TRAINING_PROFILE_IDS = {
  ...
  northstarOps: "55555555-5555-4555-8555-555555555555",
  northstarSales: "66666666-6666-4666-8666-666666666666",
  harborUser: "77777777-7777-4777-8777-777777777777",
  harborOps: "88888888-8888-4888-8888-888888888888",
  harborSupport: "99999999-9999-4999-8999-999999999999",
} as const;
...
export const TRAINING_TEAM_MEMBER_IDS = {
  ...
  harborAdmin: "22222222-3333-4333-8333-222222222223",
  northstarOps: "11111111-2222-4222-8222-111111111112",
  northstarSales: "11111111-3333-4333-8333-111111111113",
  harborUser: "11111111-4444-4444-8444-111111111114",
  harborOps: "11111111-5555-4555-8555-111111111115",
  harborSupport: "11111111-6666-4666-8666-111111111116",
} as const;
...
export const TRAINING_PROFILES = [
  ...
  {
    id: TRAINING_PROFILE_IDS.northstarOps,
    email: TRAINING_ACCOUNTS.northstarUsers.ops.email,
    password: TRAINING_ACCOUNTS.northstarUsers.ops.password,
  ...
  {
    id: TRAINING_PROFILE_IDS.northstarSales,
    email: TRAINING_ACCOUNTS.northstarUsers.sales.email,
    password: TRAINING_ACCOUNTS.northstarUsers.sales.password,
  ...
  {
    id: TRAINING_PROFILE_IDS.harborUser,
    email: TRAINING_ACCOUNTS.harborUsers.user.email,
    password: TRAINING_ACCOUNTS.harborUsers.user.password,
  ...
  {
    id: TRAINING_PROFILE_IDS.harborOps,
    email: TRAINING_ACCOUNTS.harborUsers.ops.email,
    password: TRAINING_ACCOUNTS.harborUsers.ops.password,
    full_name: "Omar Ali",
  ...
  {
    id: TRAINING_PROFILE_IDS.harborSupport,
    email: TRAINING_ACCOUNTS.harborUsers.support.email,
    password: TRAINING_ACCOUNTS.harborUsers.support.password,
    full_name: "Zoya Khan",
...
export const TRAINING_USER_ROLES = [
  ...
  { user_id: TRAINING_PROFILE_IDS.northstarOps, role: "partner_user", is_seed: true },
  { user_id: TRAINING_PROFILE_IDS.northstarSales, role: "partner_user", is_seed: true },
  { user_id: TRAINING_PROFILE_IDS.harborUser, role: "partner_user", is_seed: true },
  { user_id: TRAINING_PROFILE_IDS.harborOps, role: "partner_user", is_seed: true },
  { user_id: TRAINING_PROFILE_IDS.harborSupport, role: "partner_user", is_seed: true },
] as const;
...
export const TRAINING_USER_ROLE_IDS = {
  ...
  northstarOps: "61616161-6161-4616-8616-616161616161",
  northstarSales: "71717171-7171-4717-8717-717171717171",
  harborUser: "81818181-8181-4818-8818-818181818181",
  harborOps: "91919191-9191-4919-8919-919191919191",
  harborSupport: "a1a1a1a1-a1a1-4a1a-8a1a-a1a1a1a1a1a1",
} as const;
...
export const TRAINING_TEAM_MEMBERS = [
  ...
  {
    id: TRAINING_TEAM_MEMBER_IDS.harborAdmin,
    company_name: "Harbor Logistics",
    full_name: "Ananya Rao",
    email: TRAINING_ACCOUNTS.harborAdmin.email,
    role_title: "Partner Operations Lead",
    portal_role: "partner_admin",
    responsibility: "Owns the Harbor partner workspace and approvals",
    status: "active",
  ...
  {
    id: TRAINING_TEAM_MEMBER_IDS.northstarSales,
    company_name: "Northstar Systems",
    full_name: "Karan Mehta",
    email: TRAINING_ACCOUNTS.northstarUsers.sales.email,
    role_title: "Sales Manager",
    portal_role: "partner_user",
    responsibility: "Tracks active opportunities and renewals",
    status: "active",
    last_active: "1 hour ago",
    phone: "+91 98765 43214",
    permissions: ["deals", "documents"],
    is_seed: true,
  },
  {
    id: TRAINING_TEAM_MEMBER_IDS.harborUser,
    company_name: "Harbor Logistics",
    full_name: "Rhea Menon",
    email: TRAINING_ACCOUNTS.harborUsers.user.email,
    role_title: "Operations Coordinator",
    portal_role: "partner_user",
    responsibility: "Keeps onboarding tasks and paperwork moving",
    status: "active",
    last_active: "32 minutes ago",
    phone: "+91 98765 43215",
    permissions: ["documents"],
    is_seed: true,
  },
  {
    id: TRAINING_TEAM_MEMBER_IDS.harborOps,
    company_name: "Harbor Logistics",
    full_name: "Omar Ali",
    email: TRAINING_ACCOUNTS.harborUsers.ops.email,
    role_title: "Operations Lead",
    portal_role: "partner_user",
    responsibility: "Coordinates partner operations and approvals",
    status: "active",
  ...
  {
    id: TRAINING_TEAM_MEMBER_IDS.harborSupport,
    company_name: "Harbor Logistics",
    full_name: "Zoya Khan",
    email: TRAINING_ACCOUNTS.harborUsers.support.email,
    role_title: "Customer Support Lead",
    portal_role: "partner_user",
    responsibility: "Handles customer follow-up and issue resolution",
    status: "active",
...
export const TRAINING_VIDEO_ASSERTIONS: TrainingCountAssertion[] = [
  ...
  {
    key: "partner-admins",
    label: "partner admin roles",
    sql: `SELECT count(*)::int AS count FROM user_roles WHERE is_seed = true AND role = 'partner_admin'`,
    min: 2,
  },
  {
    key: "partner-users",
    label: "partner user roles",
    sql: `SELECT count(*)::int AS count FROM user_roles WHERE is_seed = true AND role = 'partner_user'`,
    min: 6,
  },
  {
